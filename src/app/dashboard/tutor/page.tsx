        ...
        >
            ...
            >
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">
                    Manage your sessions and monitor student progress
                </p>
            </motion.div>
            ...
            >
                {[
                    { label: 'Active Students', value: stats?.activeStudents || 0, icon: Users, change: `${stats?.totalEnrollments || 0} total enrollments`, color: 'blue' },
                    { label: 'Sessions Completed', value: stats?.sessionsCompleted || 0, icon: CheckCircle, change: `${stats?.totalSessions || 0} total sessions`, color: 'purple' },
                    { label: 'Upcoming Sessions', value: stats?.upcomingSessions || 0, icon: Calendar, change: 'scheduled', color: 'green' },
                    { label: 'My Courses', value: stats?.totalCourses || 0, icon: BookOpen, change: 'active courses', color: 'yellow' },
                ].map((stat, index) => (
                                        ...
                                        <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                            <div className="flex items-center gap-2">
                                                <span className={clsx(
                                                    ...
                                                    {booking.status === 'scheduled' ? 'Confirmed' : booking.status}
                                                </span>
                    ...
                    <Card className="p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-gray-200/50 dark:border-gray-700/50">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">Course overview</p>
                            </div>
                        </div>
                ...
                <Card className="p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-gray-200/50 dark:border-gray-700/50">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">My Rating</h2>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Student feedback coming soon</p>
                            </div>
                        </div>
                        <div className="text-right">
